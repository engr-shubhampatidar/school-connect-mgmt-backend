...
export class GetAttendanceQueryDto {
  @ApiProperty({ description: 'Class UUID', example: 'a1b2c3d4-e5f6-7a8b-9c0d-111213141516' })
  @IsString()
  classId: string;
...
export class ClassHistoryQueryDto {
  @ApiPropertyOptional({ description: 'Start date (YYYY-MM-DD)', example: '2025-12-01' })
  @IsOptional()
